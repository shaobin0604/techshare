...
//        stopAsyncTask(mIconLoader);
    ...
    private final ArrayList<OnNotificationDataChangedListener> mListeners = new ArrayList<OnNotificationDataChangedListener>(3);
    ...
    public String toString() {
        return "NotificationData [packageName=" + packageName + ", when=" + new Date(when)
                + ", pendingIntent=" + pendingIntent + ", titleText=" + titleText
                + ", messageText=" + messageText + ", messageTextLarge=" + messageTextLarge
                + ", infoText=" + infoText + ", subText=" + subText + ", summaryText="
                + summaryText + ", actions=" + Arrays.toString(actions) + ", icon=" + icon
                + ", circleIcon=" + circleIcon + ", background=" + background + ", number="
                + number + ", isRead=" + isRead + ", mListeners=" + mListeners + "]";
    }
