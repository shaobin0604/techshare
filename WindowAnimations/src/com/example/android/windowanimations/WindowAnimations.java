...
public class WindowAnimations extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Button translateButtonActivityOptions = (Button) findViewById(R.id.translateButtonActivityOptions);
        final Button translateButtonThemeStyle = (Button) findViewById(R.id.translateButtonThemeStyle);
        final Button translateButtonOverridePendingTransition = (Button) findViewById(R.id.translateButtonOverridePendingTransition);
        ...
        translateButtonOverridePendingTransition.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent subActivity = new Intent(WindowAnimations.this,
        ...
        // Custom animations allow us to do things like slide the next activity in as we
        // slide this activity out
        translateButtonActivityOptions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
